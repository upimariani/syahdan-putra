					...
					<nav class="pcoded-navbar">
						...
						<div class="pcoded-inner-navbar main-menu">
							<div class="">
								<div class="main-menu-header">
									...
									<div class="user-details">
										<span id="more-details">Reseller<i class="fa fa-caret-down"></i></span>
									</div>
								</div>
							...
							<ul class="pcoded-item pcoded-left-item">
								<li class="<?php if ($this->uri->segment(1) == 'Reseller' && $this->uri->segment(2) == 'cDashboard') {
												echo 'active';
											}  ?>">
									<a href="<?= base_url('Reseller/cDashboard') ?>" class="waves-effect waves-dark">
							...
							<ul class="pcoded-item pcoded-left-item">
								<li class="<?php if ($this->uri->segment(1) == 'Reseller' && $this->uri->segment(2) == 'cTransaksiBeras') {
												echo 'active';
											}  ?>">
									<a href="<?= base_url('Reseller/cTransaksiBeras') ?>" class="waves-effect waves-dark">
