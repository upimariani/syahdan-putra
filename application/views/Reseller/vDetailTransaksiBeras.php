									...
									<div class="invoice p-3 mb-3">
										...
										<div class="row no-print">
											<div class="col-12">
												...
												<?php
												if ($transaksi['transaksi']->status_transaksi == '3') {
												?>
													<a href="<?= base_url('Reseller/cTransaksiBeras/pesanan_diterima/' . $transaksi['transaksi']->id_transaksi) ?>" class="mt-5 btn btn-success"> Pesanan Diterima</a>
