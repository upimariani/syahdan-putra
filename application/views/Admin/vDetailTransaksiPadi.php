									...
									<div class="invoice p-3 mb-3">
										...
										<div class="row">
											...
											<div class="col-6">
												...
												?>
													<?php echo form_open_multipart('Admin/cTransaksiPadi/bayar/' . $transaksi['transaksi']->id_pesan); ?>
										...
										<div class="row no-print">
											<div class="col-12">
												...
												<?php
												if ($transaksi['transaksi']->status_pesan == '3') {
												?>
													<a href="<?= base_url('Admin/cTransaksiPadi/pesanan_diterima/' . $transaksi['transaksi']->id_pesan) ?>" class="mt-5 btn btn-success"> Pesanan Diterima</a>
