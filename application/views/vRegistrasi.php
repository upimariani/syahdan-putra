		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					...
					<form action="<?= base_url('cLogin/registrasi') ?>" method="post" class="md-float-material form-material">

						<div class="auth-box card">
							<div class="card-block">
								<div class="row m-b-20">
									<div class="col-md-12">
										<h3 class="text-center">Registrasi Reseller</h3>
								...
								<div class="form-group form-primary">
									<input type="text" name="nama" class="form-control" placeholder="Nama Reseller">
